import svgPaths from "./svg-0jjvu92knx";
import imgMasthead from "./7e50743c804ee3c01b7423cd7410540d607630a7.png";
import imgCheckedIcon from "./2d7c77eefc195fd38c3bf0bc34a67c2936bca7f0.png";
...
function Paragraph() {
  return (
    <div className="h-[16px] relative shrink-0 w-full" data-name="Paragraph">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute capitalize flex flex-col font-['Jost:Regular',sans-serif] font-normal justify-center leading-[0] left-[calc(50%-34.77px)] text-[#222] text-[12px] text-center top-[8px] whitespace-nowrap">
        <p>
...
function CheckedIcon() {
  return (
    <div className="max-w-[1290px] relative shrink-0 size-[96px]" data-name="checked-icon">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgCheckedIcon} />
      </div>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col items-center pt-[18px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Jost:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#505157] text-[24px] text-center whitespace-nowrap">
        <p className="leading-[32px]">Thank you. Your order has been received.</p>
      </div>
    </div>
  );
}
...
function Background() {
  return (
    <div className="bg-[#f2f2f2] col-1 h-[56px] justify-self-stretch overflow-clip relative rounded-[8px] row-1 shrink-0" data-name="Background">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Jost:Regular',sans-serif] font-normal justify-center leading-[0] left-1/2 text-[#505157] text-[14px] text-center top-[28.8px] whitespace-nowrap">
        <p>
          <span className="leading-[58px]">{`Order number: `}</span>
          <span className="font-['Jost:Bold',sans-serif] font-bold leading-[58px]">11420</span>
        </p>
      </div>
    </div>
  );
...
function Background1() {
  return (
    <div className="bg-[#f2f2f2] col-2 h-[56px] justify-self-stretch overflow-clip relative rounded-[8px] row-1 shrink-0" data-name="Background">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Jost:Regular',sans-serif] font-normal justify-center leading-[0] left-1/2 text-[#505157] text-[14px] text-center top-[28.8px] whitespace-nowrap">
        <p>
          <span className="leading-[58px]">{`Date: `}</span>
          <span className="font-['Jost:Bold',sans-serif] font-bold leading-[58px]">May 9, 2026</span>
        </p>
      </div>
    </div>
  );
...
function Background2() {
  return (
    <div className="bg-[#f2f2f2] col-3 h-[56px] justify-self-stretch overflow-clip relative rounded-[8px] row-1 shrink-0" data-name="Background">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Jost:Regular',sans-serif] font-normal justify-center leading-[0] left-1/2 text-[#505157] text-[14px] text-center top-[28.8px] whitespace-nowrap">
        <p>
          <span className="leading-[58px]">{`Email: `}</span>
          <span className="font-['Jost:Bold',sans-serif] font-bold leading-[58px]">tit@gmail.com</span>
        </p>
      </div>
    </div>
  );
...
function Background3() {
  return (
    <div className="bg-[#f2f2f2] col-4 h-[56px] justify-self-stretch overflow-clip relative rounded-[8px] row-1 shrink-0" data-name="Background">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Jost:Regular',sans-serif] font-normal justify-center leading-[0] left-1/2 text-[#505157] text-[14px] text-center top-[28.8px] whitespace-nowrap">
        <p>
          <span className="leading-[58px]">{`Total: `}</span>
          <span className="font-['Jost:Bold',sans-serif] font-bold leading-[58px]">$94.00</span>
        </p>
      </div>
    </div>
  );
...
function Background4() {
  return (
    <div className="bg-[#f2f2f2] col-5 h-[56px] justify-self-stretch overflow-clip relative rounded-[8px] row-1 shrink-0" data-name="Background">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Jost:Regular',sans-serif] font-normal justify-center leading-[0] left-1/2 text-[#505157] text-[14px] text-center top-[28.8px] whitespace-nowrap">
        <p>
          <span className="leading-[58px]">{`Payment method: `}</span>
          <span className="font-['Jost:Bold',sans-serif] font-bold leading-[58px]">Cash on delivery</span>
        </p>
      </div>
    </div>
  );
...
function Container4() {
  return (
    <div className="gap-x-[10px] gap-y-[10px] grid grid-cols-[repeat(5,minmax(0,1fr))] grid-rows-[_56px] pt-[20px] relative shrink-0 w-full" data-name="Container">
      <Background />
      <Background1 />
      <Background2 />
      <Background3 />
...
function HorizontalBorder() {
  return (
    <div className="content-stretch flex h-[51px] items-start justify-between pb-[19px] pt-[8px] relative shrink-0 w-full" data-name="HorizontalBorder">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b-4 border-solid inset-0 pointer-events-none" />
      <Container8 />
      <Container9 />
    </div>
  );
...
function Container10() {
  return (
    <div className="relative self-stretch shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="flex flex-col font-['Jost:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#222] text-[14px] whitespace-nowrap">
          <p>
            ...
            <span className="font-['Jost:Regular',sans-serif] font-normal leading-[24px] text-[#505157]">× 1</span>
          </p>
        </div>
      </div>
    </div>
...
function Container11() {
  return (
    <div className="relative self-stretch shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="flex flex-col font-['Jost:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#505157] text-[14px] whitespace-nowrap">
...
function HorizontalBorder1() {
  return (
    <div className="h-[40.8px] relative shrink-0 w-full" data-name="HorizontalBorder">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b-[0.8px] border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex items-start justify-between pb-[16.8px] relative size-full">
        <Container10 />
        <Container11 />
      </div>
    </div>
...
function Paragraph1() {
  return (
    <div className="relative self-stretch shrink-0 w-[113.55px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid font-['Jost:Bold',sans-serif] font-bold leading-[0] relative size-full text-[#222] whitespace-nowrap">
        <div className="-translate-y-1/2 absolute flex flex-col justify-center left-0 text-[14px] top-[12px]">
          <p className="leading-[24px]">{`$10.00 `}</p>
        </div>
        <div className="-translate-y-1/2 absolute flex flex-col justify-center left-[52.36px] text-[11.2px] top-[12.8px]">
          <p className="leading-[24px]">via Flat rate</p>
        </div>
      </div>
    </div>
  );
...
function HorizontalBorder3() {
  return (
    <div className="h-[36.8px] relative shrink-0 w-full" data-name="HorizontalBorder">
      <div aria-hidden="true" className="absolute border-[#dfdfdf] border-b-[0.8px] border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex items-start justify-between pb-[16.8px] relative size-full">
        <Container14 />
        <Paragraph1 />
...
function HorizontalBorder4() {
  return (
    <div className="content-stretch flex h-[40.8px] items-start justify-between pb-[16.8px] relative shrink-0 w-full" data-name="HorizontalBorder">
      <div aria-hidden="true" className="absolute border-[#dfdfdf] border-b-[0.8px] border-solid inset-0 pointer-events-none" />
      <Container15 />
      <Container16 />
    </div>
...
function Container19() {
  return (
    <div className="content-stretch flex flex-col items-start relative self-stretch shrink-0" data-name="Container">
      <div className="flex flex-col font-['Jost:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#222] text-[14px] whitespace-nowrap">
        <p className="leading-[24px]">$94.00</p>
      </div>
    </div>
  );
}
...
function Container17() {
  return (
    <div className="content-stretch flex h-[40px] items-start justify-between pb-[16px] relative shrink-0 w-full" data-name="Container">
      <Container18 />
      <Container19 />
    </div>
  );
...
function Section() {
  return (
    <div className="bg-white relative rounded-[16px] shrink-0 w-full" data-name="Section">
      <div className="content-stretch flex flex-col items-start pb-[17px] pt-[30px] px-[30px] relative size-full">
        <Container7 />
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Heading 3">
      <div className="flex flex-col font-['Oswald:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#222] text-[16px] w-full">
        <p className="leading-[24px]">Billing address</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[30px] py-[18px] relative size-full">
          <Heading2 />
        </div>
      </div>
    </div>
...
function Container21() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Jost:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#505157] text-[14px] w-full">
        <p className="leading-[32px]">0691991935</p>
      </div>
    </div>
  );
}
...
function Container22() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[10px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Jost:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#505157] text-[14px] w-full">
        <p className="leading-[32px]">tit@gmail.com</p>
      </div>
    </div>
  );
}
...
function Background5() {
  return (
    <div className="bg-white relative rounded-[16px] shrink-0 w-full" data-name="Background">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[42px] pt-[32px] px-[30px] relative size-full">
        <div className="flex flex-col font-['Jost:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#505157] text-[14px] whitespace-nowrap">
          <p className="leading-[32px] mb-0">d d</p>
          <p className="leading-[32px] mb-0">d</p>
          <p className="leading-[32px] mb-0">d</p>
          <p className="leading-[32px] mb-0">d</p>
          <p className="leading-[32px] mb-0">d</p>
          <p className="leading-[32px] mb-0">d</p>
          <p className="leading-[32px] mb-0">D</p>
          <p className="leading-[32px]">Andorra</p>
        </div>
        <Container21 />
        <Container22 />
      </div>
...
function BackgroundBorder() {
  return (
    <div className="bg-[#f2f2f2] col-1 relative rounded-[24px] row-1 self-start shrink-0 w-[660px]" data-name="Background+Border">
...
function Heading3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Heading 3">
      <div className="flex flex-col font-['Oswald:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#222] text-[16px] w-full">
        <p className="leading-[24px]">Shipping address</p>
      </div>
    </div>
  );
}
...
function Background6() {
  return (
    <div className="bg-white relative rounded-[16px] shrink-0 w-full" data-name="Background">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[30px] py-[32px] relative size-full">
        <div className="flex flex-col font-['Jost:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#505157] text-[14px] whitespace-nowrap">
          <p className="leading-[32px] mb-0">d d</p>
          <p className="leading-[32px] mb-0">d</p>
          <p className="leading-[32px] mb-0">d</p>
...
function Container23() {
  return (
    <div className="col-2 content-stretch flex flex-col items-start pb-[84px] relative row-1 self-start shrink-0 w-[660px]" data-name="Container">
      <BackgroundBorder1 />
    </div>
  );
}
...
function Section1() {
  return (
    <div className="gap-x-[30px] gap-y-[30px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[_467.20px] pt-[18px] relative shrink-0 w-full" data-name="Section">
      <BackgroundBorder />
      <Container23 />
    </div>
  );
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[1350px]" data-name="Container">
      <Container6 />
      <Section />
      <Section1 />
    </div>
...
function Article() {
  return (
    <div className="content-stretch flex flex-col gap-[18px] items-center max-w-[1320px] pb-[86px] pt-[116px] relative shrink-0 w-full" data-name="Article">
      <Container2 />
      <Container3 />
      <Container4 />
      <Container5 />
...
function Container() {
  return (
    <div className="h-[2349px] relative shrink-0 w-full" data-name="Container">
      <Masthead />
      <Main />
      <div className="absolute content-stretch flex flex-col items-start left-0 right-0 top-[1789px]" data-name="Footer">
        <Section2 />
        <Section4 />
      </div>
...
export default function ThanhToanThanhCong() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Thanh toán thành công">
      <Container />
      <div className="absolute bottom-0 h-[2349px] pointer-events-none right-[20px]">
        <Background11 />
      </div>
    </div>
  );
