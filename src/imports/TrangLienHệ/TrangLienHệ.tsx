import svgPaths from "./svg-83jqoxs7s0";
import imgMasthead from "./7e50743c804ee3c01b7423cd7410540d607630a7.png";
import imgVt from "./7b244abc8b8046cc6246cae8769d89458fb15416.png";
import imgVt1 from "./7a40ecc8286fb9e2d74fff1d6bea74fada9d6dfe.png";
import imgVt2 from "./8b584f6fada39966c06eb553473e3f6a1f50e134.png";
import imgVt3 from "./ae018fddf9521d5a2d1930ac61b4ef9f0560db42.png";
import imgVt4 from "./89af2712c95f0b5f12a09be20a4ec258c0fa892c.png";
import imgVt5 from "./f06742acba8f09415978bca0b8bb0338bebe68c5.png";
import imgVt6 from "./b6c12a3e2c7f3af3951dc4bd89d402ee6adfa3c2.png";
import imgVt7 from "./25005a4095da5593b8b44fdf3194d73f77e282b9.png";
import imgVt8 from "./c8e82d7aa2ee7e1ec08d9a69e784f9a7e41518fb.png";
import imgVt9 from "./ff5a537e85df47d30e3dfac8fb2adc6dca067082.png";
import imgVt10 from "./c7ffa232c58b3ccecddf07ef19a9b562ec21702d.png";
import imgVt11 from "./7a59a515ca0a9c0f86535f9600fa3635f8148267.png";
import imgVt12 from "./180aabb546b09a853fd7a1e3c84088cefb190e6a.png";
import imgVt13 from "./ab1b89411b96344781136ee09c8dbd3a9a0bd06e.png";
import imgVt14 from "./ba4b031702e23730dc7ffbf16e4296a5d8f8784d.png";
import imgVt15 from "./ea0653c4631caab4268b3a56e9d74d4d3390c07e.png";
import imgVt16 from "./3f4b6e04608edbeee339eb558f135b1acb70d300.png";
import imgVt17 from "./585fe68e67b07cc5fd70e12ec35868822851e032.png";
import imgVt18 from "./4379db73cbca9edcde1f5324ed5619bec78212ce.png";
  ...
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading 1">
      <div className="flex flex-col font-['Oswald:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#222] text-[30px] text-center uppercase whitespace-nowrap">
        <p className="leading-[45px]">CONTACT US</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[16px] relative shrink-0 w-full" data-name="Paragraph">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute capitalize flex flex-col font-['Jost:Regular',sans-serif] font-normal justify-center leading-[0] left-[calc(50%-38.65px)] text-[#222] text-[12px] text-center top-[8px] whitespace-nowrap">
        <p>
          <span className="leading-[16px]">Home</span>
          <span className="font-['Jost:Regular',sans-serif] font-normal leading-[16px]">{` `}</span>
        </p>
      </div>
      <div className="-translate-x-1/2 absolute h-[6.997px] left-[calc(50%-10.01px)] top-[5.85px] w-[3.5px]" data-name="Symbol">
...
function Html() {
  return <div className="bg-white h-[610.4px] relative shrink-0 w-full" data-name="Html" />;
}

function Iframe() {
  return (
    <div className="absolute content-stretch flex flex-col h-[610.4px] items-start left-0 opacity-0 overflow-clip top-0 w-[1290.4px]" data-name="Iframe">
      <Html />
    </div>
  );
}
...
function Container6() {
  return (
    <div className="absolute left-[573.2px] size-0 top-[253.2px]" data-name="Container">
      <Vt />
      <Vt1 />
      <Vt2 />
      <Vt3 />
...
function MaskGroup() {
  return <div className="absolute content-stretch flex flex-col items-start left-[644.2px] size-px top-[304.2px]" data-name="Mask Group" />;
}

function Container5() {
  return (
    <div className="absolute h-[610.4px] left-0 top-0 w-[1290.4px]" data-name="Container">
      <Container6 />
      <MaskGroup />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[28px]" data-name="image">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 28">
        <g id="image">
          <path d={svgPaths.p2382cc00} fill="var(--fill-0, #666666)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function GmpInternalCameraControlButtonMapCameraControls() {
  return (
    <div className="bg-white relative rounded-[20px] shrink-0 size-[40px]" data-name="gmp-internal-camera-control → Button - Map camera controls">
      <div className="absolute bg-[rgba(255,255,255,0)] left-0 rounded-[20px] shadow-[0px_1px_4px_-1px_rgba(0,0,0,0.3)] size-[40px] top-0" data-name="Button - Map camera controls:shadow" />
      <Image />
    </div>
  );
}
...
function Container7() {
  return (
    <div className="absolute bottom-[24px] content-stretch flex flex-col items-start right-[10px]" data-name="Container">
...
function Image2() {
  return (
    <div className="h-[21.855px] relative shrink-0 w-[52px]" data-name="image">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 52 21.8551">
        <g id="image">
          <g id="Group" opacity="0.6">
            <g id="Vector">
              <path d={svgPaths.p17a6940} fill="var(--fill-0, white)" />
              <path d={svgPaths.p17a6940} stroke="var(--stroke-0, white)" strokeWidth="1.13043" />
            </g>
            <g id="Vector_2">
              <path d={svgPaths.p381e5980} fill="var(--fill-0, white)" />
              <path d={svgPaths.p381e5980} stroke="var(--stroke-0, white)" strokeWidth="1.13043" />
            </g>
            <g id="Vector_3">
              <path d={svgPaths.p119fa600} fill="var(--fill-0, white)" />
              <path d={svgPaths.p119fa600} stroke="var(--stroke-0, white)" strokeWidth="1.13043" />
            </g>
            <g id="Vector_4">
              <path d={svgPaths.pf790503} fill="var(--fill-0, white)" />
              <path d={svgPaths.pf790503} stroke="var(--stroke-0, white)" strokeWidth="1.13043" />
            </g>
            <g id="Vector_5">
              <path d={svgPaths.p3c92c800} fill="var(--fill-0, white)" />
              <path d={svgPaths.p3c92c800} stroke="var(--stroke-0, white)" strokeWidth="1.13043" />
            </g>
          </g>
          <path d={svgPaths.p122f0798} fill="var(--fill-0, #4285F4)" id="Vector_6" />
          <path d={svgPaths.p2a5e0a80} fill="var(--fill-0, #E94235)" id="Vector_7" />
          <path d={svgPaths.pd642880} fill="var(--fill-0, #FABB05)" id="Vector_8" />
          <path d={svgPaths.p22326980} fill="var(--fill-0, #4285F4)" id="Vector_9" />
          <path d={svgPaths.pa9b9890} fill="var(--fill-0, #34A853)" id="Vector_10" />
          <path d={svgPaths.p72d3880} fill="var(--fill-0, #E94235)" id="Vector_11" />
        </g>
      </svg>
    </div>
  );
...
function Google() {
  return (
    <div className="aspect-[52/21.850000381469727] content-stretch flex items-center justify-center overflow-clip relative shrink-0" data-name="Google">
      <Image2 />
    </div>
  );
}
...
function Container8() {
  return (
    <div className="absolute bottom-[124.8px] content-stretch flex flex-col items-start left-[515.2px] pb-[14.397px]" data-name="Container">
      <Google />
    </div>
  );
}
...
function Container11() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-[-193px] size-[256px] top-[-48px]" data-name="Container">
      <Vt18 />
    </div>
  );
}
...
function RegionMap() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-[38px]" data-name="Region - Map">
      <Container11 />
      <MaskGroup1 />
    </div>
  );
...
function ButtonShowSatelliteImagery() {
  return (
    <div className="bg-white relative rounded-[3px] shrink-0" data-name="Button - Show satellite imagery">
      ...
      <div aria-hidden="true" className="absolute border border-solid border-white inset-0 pointer-events-none rounded-[3px] shadow-[0px_2px_6px_0px_rgba(0,0,0,0.3)]" />
    </div>
  );
}
...
function Container9() {
  return (
    <div className="absolute bottom-[10px] content-stretch flex flex-col items-start left-[10px] pb-[0.8px]" data-name="Container">
  ...
  return (
    <div className="content-stretch flex items-start justify-end px-[6px] relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[10px] text-black text-right whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[14px]">Report a map error</p>
      </div>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="absolute content-stretch flex flex-col h-[14px] items-start left-[259.79px] top-0" data-name="Container">
...
function ButtonKeyboardShortcuts() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Button - Keyboard shortcuts">
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[10px] text-black text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[14px]">Keyboard shortcuts</p>
      </div>
    </div>
  );
}
...
function Container20() {
  return (
    <div className="content-stretch flex items-start justify-end px-[6px] relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[10px] text-black text-right whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[14px]">Map data ©2026 Google</p>
      </div>
    </div>
  );
}
...
function Container19() {
  return (
    <div className="content-stretch flex flex-col h-[14px] items-start relative shrink-0" data-name="Container">
      <div className="absolute bg-[#f5f5f5] inset-[0_-0.01px_0_1px] opacity-70" data-name="Background" />
      <Container20 />
    </div>
  );
}
...
function Container18() {
  return (
    <div className="absolute bottom-0 content-stretch flex flex-col items-start left-[98.75px] top-0" data-name="Container">
      <Container19 />
    </div>
  );
}
...
function Container22() {
  return (
    <div className="content-stretch flex items-start justify-end px-[6px] relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[10px] text-black text-right whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[14px]">Terms</p>
      </div>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="absolute content-stretch flex flex-col h-[14px] items-start left-[219.67px] top-0" data-name="Container">
      <div className="absolute bg-[#f5f5f5] inset-[0_0_0_1px] opacity-70" data-name="Background" />
      <Container22 />
    </div>
  );
...
function Container12() {
  return (
    <div className="absolute bottom-[124.8px] h-[14px] right-[103.8px] w-[355.26px]" data-name="Container">
      <Container13 />
      <Container15 />
      <Container18 />
      <Container21 />
...
function Container4() {
  return (
    <div className="absolute h-[610.4px] left-0 top-0 w-[1290.4px]" data-name="Container">
      ...
      <Container9 />
      <Container12 />
      <div className="absolute border border-[#1a73e8] border-solid h-[610.4px] left-0 opacity-0 top-0 w-[1290.4px]" data-name="Border" />
    </div>
  );
}
...
function Background() {
  return (
    <div className="bg-[#e5e3df] flex-[1_0_0] min-h-px overflow-clip relative w-full" data-name="Background">
      <div className="absolute border-2 border-[#101010] border-solid h-[610.4px] left-0 top-0 w-[1290.4px]" data-name="Region - Map" />
      <Container4 />
    </div>
  );
}
...
function SvgLit() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="SVG - lit$367137433">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG - lit$367137433">
          <path d={svgPaths.p1b6c0200} fill="var(--fill-0, #1A73E8)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Lit() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex items-start left-[calc(50%+44.74px)] top-[1.9px] w-[16px]" data-name="lit$367137433">
      <SvgLit />
    </div>
  );
}

function LinkOpenInMapsOpensInNewTab() {
  return (
    <div className="h-[16.8px] relative shrink-0 w-[105.49px]" data-name="Link - Open in Maps (opens in new tab)">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] left-[calc(50%-8px)] text-[#1a73e8] text-[14px] text-center top-[8.4px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal]">{`Open in Maps `}</p>
      </div>
      <Lit />
    </div>
  );
...
function EmbedPlaceCardElement() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-center left-[8px] pb-[9.1px] pt-[8px] px-[12px] rounded-[2px] top-[8px]" data-name="embed-place-card-element">
      <div className="absolute bg-[rgba(255,255,255,0)] inset-0 rounded-[2px] shadow-[0px_1px_4px_-1px_rgba(0,0,0,0.3)]" data-name="Overlay+Shadow" />
      <LinkOpenInMapsOpensInNewTab />
    </div>
  );
}
...
function HtmlBody() {
  return (
    <div className="bg-[#808080] content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-px relative w-full" data-name="Html → Body">
      <Background />
      <EmbedPlaceCardElement />
    </div>
  );
}

function IframeLondonEyeLondonUnitedKingdom() {
  return (
    <div className="content-stretch flex flex-col h-[610px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Iframe - London Eye, London, United Kingdom">
      <HtmlBody />
    </div>
  );
}
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[20px] shrink-0 w-full" data-name="Container">
      <IframeLondonEyeLondonUnitedKingdom />
    </div>
  );
}
...
function Section() {
  return (
    <div className="content-stretch flex h-[630px] items-start justify-center max-w-[1310px] py-[10px] relative shrink-0 w-full" data-name="Section">
      <Container2 />
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[0.6px] relative shrink-0 w-full" data-name="Heading 2">
      <div className="flex flex-col font-['Oswald:Bold',sans-serif] font-extrabold justify-center leading-[0] relative shrink-0 text-[#222] text-[22px] w-full">
        <p className="leading-[26px]">GET IN TOUCH</p>
      </div>
    </div>
  );
}
...
function Container26() {
  return (
    <div className="absolute content-stretch flex flex-col inset-[-0.6px_0_2px_0] items-start" data-name="Container">
      <Heading1 />
    </div>
  );
}
...
function Container28() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Jost:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#7a7a7a] text-[12px] w-full">
        <p className="leading-[24px]">Please enter the details of your request. A member of our support staff will respond as soon as possible.</p>
      </div>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip pr-[275.01px] relative rounded-[inherit] size-full">
        <div className="flex flex-col font-['Jost:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#a8a8a8] text-[10px] uppercase whitespace-nowrap">
...
function Input() {
  return (
    <div className="bg-white h-[50px] relative rounded-[4px] shrink-0" data-name="Input">
      <div className="content-stretch flex items-start overflow-clip pb-[17px] pt-[18.6px] px-[22.8px] relative rounded-[inherit] size-full">
        <Container31 />
      </div>
...
function Label() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 pb-[10px] pr-[5px] right-1/2 top-[20px]" data-name="Label">
      <Container30 />
    </div>
  );
}
...
function Container33() {
  return (
    <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip pr-[274.9px] relative rounded-[inherit] size-full">
        <div className="flex flex-col font-['Jost:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#a8a8a8] text-[10px] uppercase whitespace-nowrap">
...
function Label1() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-1/2 pb-[10px] pl-[5px] right-0 top-[20px]" data-name="Label">
      <Container32 />
    </div>
  );
}
...
function Container34() {
  return (
    <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip pr-[684.45px] relative rounded-[inherit] size-full">
        <div className="flex flex-col font-['Jost:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#a8a8a8] text-[10px] uppercase whitespace-nowrap">
...
function Input2() {
  return (
    <div className="absolute bg-white h-[50px] left-0 right-0 rounded-[4px] top-[-13.8px]" data-name="Input">
      <div className="content-stretch flex items-start overflow-clip pb-[17px] pt-[18.6px] px-[22.8px] relative rounded-[inherit] size-full">
        <Container34 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#d6d6d6] border-solid inset-0 pointer-events-none rounded-[4px]" />
...
function Label2() {
  return (
    <div className="absolute h-[20.8px] left-0 top-[93.8px] w-[770px]" data-name="Label">
      <Input2 />
    </div>
  );
}
...
function Textarea() {
  return (
    <div className="absolute bg-white left-0 max-h-[210px] right-0 rounded-[4px] top-[-214.8px]" data-name="Textarea">
      <div className="content-stretch flex items-start max-h-[inherit] overflow-auto pb-[169.2px] pl-[22.8px] pr-[670.1px] pt-[16.8px] relative size-full">
        <div className="flex flex-col font-['Jost:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#a8a8a8] text-[10px] uppercase whitespace-nowrap">
          <p className="leading-[24px]">YOUR MESSAGE</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d6d6d6] border-solid inset-0 pointer-events-none rounded-[4px]" />
    </div>
...
function Label3() {
  return (
    <div className="absolute h-[20.8px] left-0 top-[354.8px] w-[770px]" data-name="Label">
      <Textarea />
    </div>
  );
}
...
function Container29() {
  return (
    <div className="h-[377.2px] relative shrink-0 w-full" data-name="Container">
      <Label />
      <Label1 />
      <Label2 />
      <Label3 />
...
function Input3() {
  return (
    <div className="bg-black h-[50px] relative rounded-[4px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start justify-center pb-[13.4px] pt-[12.6px] px-[22.8px] relative size-full">
          <div className="flex flex-col font-['Oswald:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[10px] text-center text-white uppercase whitespace-nowrap">
            <p className="leading-[24px]">SUBMIT NOW</p>
          </div>
        </div>
      </div>
...
function FormContactForm() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start max-w-[770px] relative shrink-0 w-[770px]" data-name="Form - Contact form">
      <Container28 />
      <Container29 />
      <Container35 />
    </div>
...
function Container27() {
  return (
    <div className="content-stretch flex flex-col h-[483.2px] items-start pt-[8px] relative shrink-0 w-full" data-name="Container">
      <FormContactForm />
    </div>
  );
}
...
function Container24() {
  return (
    <div className="content-stretch flex items-start justify-center min-h-px relative self-stretch shrink-0 w-[866.65px]" data-name="Container">
      <Container25 />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Jost:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#222] text-[14px] w-full">
        <p className="mb-0">
          <span className="leading-[24px]">{`Address: `}</span>
          <span className="font-['Jost:Regular',sans-serif] font-normal leading-[24px] text-[#505157]">123 Suspendis matti, Visaosang Building VST District,</span>
        </p>
        <p className="font-['Jost:Regular',sans-serif] font-normal leading-[24px] text-[#505157]">NY Accums, North American</p>
      </div>
    </div>
  );
}
    ...
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Container">
      <div className="flex flex-col font-['Jost:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#222] text-[14px] w-full">
        <p>
          ...
          <span className="font-['Jost:Regular',sans-serif] font-normal leading-[24px] text-[#505157]">support@domain.com</span>
        </p>
      </div>
    </div>
  );
...
function Item() {
  return (
    <div className="content-stretch flex items-center pb-[5px] relative shrink-0 w-full" data-name="Item">
      <Container39 />
    </div>
  );
}
...
function Container40() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Container">
      <div className="flex flex-col font-['Jost:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#222] text-[14px] w-full">
        <p>
          <span className="leading-[24px]">Call Us:</span>
          <span className="font-['Jost:Regular',sans-serif] font-normal leading-[24px] text-[#505157]">{` (012)-345-67890`}</span>
        </p>
      </div>
    </div>
  );
...
function List() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start relative shrink-0 w-full" data-name="List">
      <Item />
      <Item1 />
    </div>
  );
...
function Container41() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Jost:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#222] text-[14px] w-full">
        <p className="mb-0">
          <span className="leading-[24px]">{`Opening time: `}</span>
          <span className="font-['Jost:Regular',sans-serif] font-normal leading-[24px] text-[#505157]">Our store has re-opened for shopping, exchanges</span>
        </p>
        <p>
          <span className="font-['Jost:Regular',sans-serif] font-normal leading-[24px] text-[#505157]">{`every day `}</span>
          <span className="leading-[24px]">11am to 7pm</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[15px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="Container">
          <path d={svgPaths.p1554e100} fill="var(--fill-0, white)" id="Symbol" />
        </g>
      </svg>
    </div>
  );
...
function Container43() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 size-[15px]" data-name="Container">
      <Container44 />
    </div>
  );
}
...
function ListitemLink() {
  return (
    <div className="bg-black content-stretch flex items-center justify-center relative rounded-[4px] shrink-0 size-[30px]" data-name="Listitem → Link">
      <Container43 />
    </div>
  );
}
...
function Container46() {
  return (
    <div className="relative shrink-0 size-[15px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="Container">
          <path d={svgPaths.pc096880} fill="var(--fill-0, white)" id="Symbol" />
        </g>
      </svg>
    </div>
  );
...
function Container48() {
  return (
    <div className="h-[15px] relative shrink-0 w-[13.13px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.13 15">
        <g id="Container">
          <path d={svgPaths.p12ecbd40} fill="var(--fill-0, white)" id="Symbol" />
        </g>
      </svg>
    </div>
  );
...
function Container47() {
  return (
    <div className="content-stretch flex flex-col items-start pl-[0.94px] pr-[0.93px] relative shrink-0 size-[15px]" data-name="Container">
      <Container48 />
    </div>
  );
}
...
function Container50() {
  return (
    <div className="h-[15px] relative shrink-0 w-[13.13px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.1543 15">
        <g id="Container">
          <path d={svgPaths.p3971e480} fill="var(--fill-0, white)" id="Symbol" />
        </g>
      </svg>
    </div>
  );
...
function Container52() {
  return (
    <div className="h-[15px] relative shrink-0 w-[16.88px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.88 15">
        <g id="Container">
          <path d={svgPaths.p269ed00} fill="var(--fill-0, white)" id="Symbol" />
        </g>
      </svg>
    </div>
  );
...
function Container51() {
  return (
    <div className="content-stretch flex flex-col h-[15px] items-start relative shrink-0 w-[15.94px]" data-name="Container">
      <Container52 />
    </div>
  );
}
...
function ListitemLink4() {
  return (
    <div className="bg-black content-stretch flex items-center justify-center pl-[6.56px] pr-[7.5px] relative rounded-[4px] shrink-0 size-[30px]" data-name="Listitem → Link">
      <Container51 />
    </div>
  );
}
...
function List1() {
  return (
    <div className="content-stretch flex gap-[5px] items-start relative shrink-0 w-full" data-name="List">
      <ListitemLink />
      <ListitemLink1 />
      <ListitemLink2 />
      <ListitemLink3 />
...
function Container42() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[90px] pt-[12px] relative shrink-0 w-full" data-name="Container">
      <List1 />
    </div>
  );
}
...
function Container37() {
  return (
    <div className="flex-[1_0_0] h-full min-w-px relative" data-name="Container">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[15px] relative size-full">
          <Margin1 />
          <Margin2 />
          <Margin3 />
          <Container42 />
...
function Container36() {
  return (
    <div className="content-stretch flex items-start justify-center min-h-px relative self-stretch shrink-0 w-[433.33px]" data-name="Container">
      <Container37 />
    </div>
  );
}
...
function Container23() {
  return (
    <div className="content-stretch flex h-[531.2px] items-start max-w-[1300px] relative shrink-0 w-full" data-name="Container">
      <Container24 />
      <Container36 />
    </div>
  );
...
function Section1() {
  return (
    <div className="content-stretch flex flex-col items-start px-[110.5px] relative shrink-0 w-[1521px]" data-name="Section">
      <Container23 />
    </div>
  );
}
...
function Article() {
  return (
    <div className="content-stretch flex flex-col gap-[88px] items-center relative shrink-0 w-full" data-name="Article">
      <Section />
      <Section1 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[36px]" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36 36">
        <g clipPath="url(#clip0_1_5308)" id="SVG">
...
function Container132() {
  return (
    <div className="content-stretch flex items-center min-h-[50px] relative shrink-0 size-[50px]" data-name="Container">
      <Container133 />
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-[#ededed] content-stretch flex items-center justify-center p-[15px] relative rounded-[50px] shrink-0" data-name="Button">
      <Container132 />
      <Background5 />
    </div>
  );
...
function Background4() {
  return (
    <div className="content-stretch flex items-start min-h-[50px] min-w-[50px] relative shrink-0" data-name="Background">
      <Button />
    </div>
  );
}
...
function Container130() {
  return (
    <div className="content-stretch flex items-start pr-[10px] relative shrink-0" data-name="Container">
      <Container131 />
    </div>
  );
}
  ...
  return (
    <div className="absolute left-0 size-[46px] top-0" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 46 46">
        <g clipPath="url(#clip0_1_5289)" id="SVG">
...
export default function TrangLienH() {
  return (
