  ...
  return (
    <div className="bg-white text-[#111]">
      <section className="border-y border-black/10 bg-[#f6f6f6]">
        <div className="mx-auto max-w-[1060px] px-4 py-14 sm:px-6 lg:px-8">
      ...
      {detailedItems.length === 0 ? (
        ...
        <section className="mx-auto grid max-w-[1060px] gap-8 px-4 py-14 sm:px-6 lg:grid-cols-[1fr_360px] lg:px-8">
