  ...
  return (
    <div className="bg-white text-[#111]">
      <section className="border-y border-black/10 bg-[#f6f6f6]">
        <div className="mx-auto grid max-w-[1060px] gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
          <div>
      ...
      <section className="mx-auto max-w-[1060px] px-4 py-16 sm:px-6 lg:px-8">
      ...
      <section className="mx-auto grid max-w-[1060px] gap-8 px-4 py-16 sm:px-6 lg:grid-cols-[0.75fr_1.25fr] lg:px-8">
        <div>
      ...
      <section className="border-t border-black/10 py-10">
        <div className="mx-auto flex max-w-[1060px] flex-wrap items-center justify-center gap-10 px-4 sm:px-6 lg:px-8">
      ...
      <section className="mx-auto max-w-[1060px] px-4 pb-16 sm:px-6 lg:px-8">
