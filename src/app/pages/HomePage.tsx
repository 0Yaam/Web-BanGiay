...
function HomeHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 w-screen border-b border-black/10 bg-white/90 backdrop-blur-xl">
      <div className="relative mx-auto flex h-[76px] w-full max-w-[1060px] items-center justify-between px-4 sm:px-6 lg:px-8">
        <button
          type="button"
          aria-label="Menu"
          title="Menu"
  ...
  return (
    <div className="bg-white text-[#111]">
      ...
      <section className="mate-hero relative overflow-hidden border-b border-black/10">
        ...
        <div className="relative mx-auto grid max-w-[1060px] gap-10 px-4 py-10 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8 lg:py-16">
      ...
      <section className="mx-auto grid max-w-[1060px] gap-5 px-4 pb-16 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8">
      ...
      <section className="mx-auto grid max-w-[1060px] gap-5 px-4 py-16 sm:px-6 lg:grid-cols-3 lg:px-8">
      ...
      <section className="border-y border-black/10 bg-black py-16 text-white">
        <div className="mx-auto grid max-w-[1060px] gap-8 px-4 sm:px-6 lg:grid-cols-[0.75fr_1.25fr] lg:px-8">
          <div>
      ...
      <footer className="bg-white">
        <div className="mx-auto grid max-w-[1060px] gap-8 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_1.2fr_1fr] lg:px-8">
          <div>
            <img src={logoMate} alt="Mate Shoes" className="h-6 w-auto" />
